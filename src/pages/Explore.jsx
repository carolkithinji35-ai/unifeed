...
function Explore() {
    ...
    const exploreDestinations = [
        {
            label: "Events",
            description: "See what is happening on campus.",
            path: "/events",
            icon: CalendarDays,
        ...
        {
            label: "Communities",
            description: "Explore broad campus spaces.",
            path: "/communities",
            icon: UsersRound,
        ...
        {
            label: "Groups",
            description: "Open your private invite-only groups.",
            path: "/groups",
            icon: UserRound,
                ...
                {exploreDestinations.map((destination) => {
                    ...
                    return (
                        <Link
                            ...
                            to={destination.path}
                            className="min-w-[10.5rem] shrink-0 snap-start rounded-2xl border border-white/8 bg-white/[0.035] p-3 transition hover:border-lime-300/30 hover:bg-white/[0.06]"
                        >
                            <span
                                className={`grid size-9 place-items-center rounded-xl ${destination.tone}`}
                            >
